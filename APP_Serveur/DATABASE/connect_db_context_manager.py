...
#
# EZ 2020.07.15 Classe pour se connecter à la base de donnée.
#
...
class MaBaseDeDonnee():
    ...
    def __init__(self):
        ...
        self.user = 'root'
        self.password = 'root'
        self.db = "erblin_zeqiri_conf_serveur_1c_2020"
        ...
        # EZ 2020.07 Il y a un problème avec la BD (non connectée, nom erronné, etc)
        #
        except (Exception,
    ...
    # EZ 2020.07.11 Cette méthode est définie pour utiliser les "context manager"
