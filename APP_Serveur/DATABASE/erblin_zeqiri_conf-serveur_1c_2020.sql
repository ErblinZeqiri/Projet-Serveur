...
--
ALTER TABLE `t_pers_a_mail`
  MODIFY `ID_Pers_A_Mail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT pour la table `t_pers_a_serveur`
--
ALTER TABLE `t_pers_a_serveur`
  MODIFY `ID_Pers_A_Serveur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `t_serv_a_location`
  MODIFY `ID_Serv_A_Location` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT pour la table `t_serv_a_status`
--
ALTER TABLE `t_serv_a_status`
  MODIFY `ID_Serv_A_Status` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pour la table `t_serv_a_type_equipement`
--
ALTER TABLE `t_serv_a_type_equipement`
  MODIFY `ID_Serv_A_Type_Equipement` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `t_type_equipement`
  MODIFY `ID_Type_Equipement` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
