# routes.py
# EZ 2020.07.12 Pour faire des tests divers et variés.
...
# EZ 2020.07.19 Pour une démonstration du traitement d'erreurs avec "raise"
...
def personnes_taille_dict():
    ...
    taille_personnes_dict = {"Pignon" : 194, "Gégé" : 175, "Hugo" : 163}
    #
    # EZ 2020.07.19 Pour vos essais, il suffit d'enlever le # pour voir comment fonctionne pratiquement
